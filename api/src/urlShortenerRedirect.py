...
def lambda_handler(event, context):
    ...
    match operation:
        case 'GET':
            result = dynamo.query(TableName = shortURLTableName, ExpressionAttributeValues={':shortedURL': {'S': event["requestContext"]["path"].split("/")[-1]},}, KeyConditionExpression = 'shortedURL = :shortedURL')
